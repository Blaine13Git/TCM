...
import com.tc.framework.util.FileUtil;
...
//                System.out.println("-----" + row.getCell(i).getStringCellValue());
    ...
    private void writeContentXml(TestCase testCase,String path){
        ...
        Element sheet = root.addElement("sheet")
                .addAttribute("id", XmindConstant.ZEN_ROOT_VERSION) // 给sheet添加属性id
                .addAttribute("modified-by", XmindConstant.XMIND_MODIFIED_VERSION) // 给sheet添加属性modified-by
                .addAttribute("theme", XmindConstant.XMIND_THEME_VERSION) // 给sheet添加属性theme
                .addAttribute("timestamp", XmindConstant.XMIND_CREATED_VERSION); // 给sheet添加属性timestamp
        ...
        Element topic = sheet.addElement("topic") // 给sheet添加新的节点topic
                .addAttribute("id",rootObj.getJSONObject(XmindConstant.DATA).getString("id")) // 获得id
                .addAttribute("modified-by","xc") // 获得用户名
                .addAttribute("timestamp",rootObj.getJSONObject(XmindConstant.DATA).getString("created")); // 获得创建时间戳
